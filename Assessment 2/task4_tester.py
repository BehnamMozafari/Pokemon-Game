...
class TestTask4(TesterBase):
    ...
    def test_battle_example(self):
        ...
        try:
            assert str(b.team_1) == "Squirtle's HP = 8 and level = 1, Charmander's HP = 7 and level = 2, Charmander's HP = 7 and level = 2, Bulbasaur's HP = 7.0 and level = 1, Bulbasaur's HP = 8.0 and level = 2"
        except AssertionError:
            self.verificationErrors.append(f"Team 1 is not correct after battle: {str(b.team_1)}")
    ...
    #             try:
    #                 assert str(
    #                     b.team1) == "Squirtle's HP = 8 and level = 1, Charmander's HP = 7 and level = 2, Charmander's HP = 7 and level = 2, Bulbasaur's HP = 7.0 and level = 1, Bulbasaur's HP = 8.0 and level = 2"
    #             except AssertionError:
    #                 self.verificationErrors.append(f"Team 1 is not correct after battle: {str(b.team1)}")
